...
<body>
   ...
   <sf:form modelAttribute="phuKien" action="${base }/admin/them-phu-kien-spring" method="post" enctype="multipart/form-data">
   	<div class="content-them">
   <h1>Thêm sản phẩm</h1>
   <div id="upanh">
    <p><img src="${base }/image/${phuKien.hinhAnh}" alt="" class="hienthianh"></p>
    <p><input type="file" name="anhSanPham" id="" class="chonanh"></p>
   </div>

   <div class="content-body">
   		<c:if test="${phuKien.id != null }">
   			<p>Mã sản phẩm <br>
        ...
        <%-- <p> Loại sản phẩm <br>
         ...
         --%>
         <p>Loại sản phẩm</p>
         <sf:select path="danhMucPhuKien.id">
         	<sf:options items="${danhMucPhuKien }" itemValue="id" itemLabel="tenDanhMuc"/>
         </sf:select>
